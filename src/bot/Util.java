...
public class Util {
	...
	/**
	 * Indicates if login failed. If login failed, it was because the remind link
	 * exists
	 * 
	 * @param driv
	 *            Name of Webdriver to search
	 * @param bot
	 *            Name of Robot to click with
	 * @return true if login failed, false if login was successful
	 */
	public static boolean loginFailed(WebDriver driv, Robot bot, ArrayList<WebElement> list, WebDriverWait wait)
	 ...
	 */
	public static String clipboardContent() throws Exception { // This method is the method that gets gets the content
																// from cboard
