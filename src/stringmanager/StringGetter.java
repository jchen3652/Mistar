...
public class StringGetter {
	/**
	   * All inclusive method that takes clipboard input and writes to file
	   * @param cBoardStringInput raw input from clipboard
	   * @param driver WebDriver object name
	   * @param where Attemped path of file location
	   */
